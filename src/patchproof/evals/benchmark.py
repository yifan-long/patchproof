...
def _run_cli(args: argparse.Namespace) -> None:
    ...
    if args.command == "smoke":
        ...
        from .orchestrator import EvaluationOperationalError, EvaluationOptions
        ...
        try:
            ...
            if isinstance(exc, EvaluationOperationalError):
                ...
                from .orchestrator import _provider_failure_category, _safe_provider_message
