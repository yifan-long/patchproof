...
def test_v02_corpus_has_five_mini_repos_and_five_unresolved_official_descriptors():
    ...
    assert {case.project for case in public} >= {"youtube-dl", "PySnooper", "black", "cookiecutter"}
